...
const VerifiedIcon = () => (
  <svg width="13" height="13" viewBox="0 0 24 24" fill="#1d5669" aria-label="Verified"><path fillRule="evenodd" d="M12 1.5l9 3.375v7.5c0 5.25-3.75 10.125-9 11.625C6.75 22.5 3 17.625 3 12.375v-7.5L12 1.5zm4.28 7.72a.75.75 0 00-1.06-1.06L10.5 12.88 8.78 11.16a.75.75 0 00-1.06 1.06l2.25 2.25a.75.75 0 001.06 0l5.25-5.25z" clipRule="evenodd"/></svg>
)
const ShieldIcon = () => (
  <svg width="12" height="12" viewBox="0 0 24 24" fill="currentColor"><path fillRule="evenodd" d="M12 1.5l9 3.375v7.5c0 5.25-3.75 10.125-9 11.625C6.75 22.5 3 17.625 3 12.375v-7.5L12 1.5zm4.28 7.72a.75.75 0 00-1.06-1.06L10.5 12.88 8.78 11.16a.75.75 0 00-1.06 1.06l2.25 2.25a.75.75 0 001.06 0l5.25-5.25z" clipRule="evenodd"/></svg>
)
  ...
  return (
    ...
    >
      ...
      <div className={styles.meta}>
        ...
        <Badge variant="neutral" size="sm">{job.industry}</Badge>
      </div>
      ...
      <div className={styles.footer}>
        <span className={styles.pay}>
          {formatPay(job)}
          {job.payType === 'hour' && (
            <span className={styles.payUnit}> / hr</span>
          )}
        </span>
