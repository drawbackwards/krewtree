...
const toastIcons: Partial<Record<ToastVariant, React.ReactNode>> = {
  success: (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#2d7a4f" strokeWidth="2" strokeLinecap="round">
      <path d="M22 11.08V12a10 10 0 1 1-5.93-9.14" /><polyline points="22 4 12 14.01 9 11.01" />
    </svg>
  ),
  warning: (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#c97c1a" strokeWidth="2" strokeLinecap="round">
  ...
  info: (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#1d5669" strokeWidth="2" strokeLinecap="round">
        ...
        <div className={containerCls} aria-live="polite" aria-atomic="false">
          {toasts.map(t => (
            ...
            >
              ...
              <button className={styles.closeBtn} onClick={() => dismiss(t.id)} aria-label="Dismiss">
                <CloseIcon />
              </button>
            </div>
          ))}
